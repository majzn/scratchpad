...
int wav_save(const char* filename, const wav_file_t* wav) {
    ...
    file_size = 4 + sizeof(fmt_chunk_t) + sizeof(data_chunk_header_t) + wav->data_size;
...
int main(void) {
    ...
    wav_free(wav);
    printf("WAV file loaded and saved successfully\n");
    return 0;
}
*/
